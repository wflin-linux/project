<template>
  <div class="homeComponent homeNews" v-scroll-in-container="isShow" style="padding-top: 8%;">
    <div>
      <!-- 标题 -->
      <!-- <h2 class="homeComponent__title">{{ $t('home.introduce.title') }}</h2> -->
      <h3 class="homeComponent__titleSmall">
        <el-divider>aiot实验室</el-divider>
      </h3>
      <!-- 宗旨 -->
      <p class="homeComponent__tenet">
       啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈啊哈哈哈哈哈哈哈
      </p>
