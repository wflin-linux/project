...
public class RegisteredUser extends JDialog {
    // 用户名标签，密码标签
    ...
    public RegisteredUser(JFrame parent) {
        // 显式调用父类构造方法，创建模态对话框
        ...
        // 设置注册按钮的字体大小以及位置
        registerBtn.setFont(new Font("Serif", Font.BOLD, 13));
        registerBtn.setBounds(130, 80, 70, 20);

        try {
            // 实例化u并将这个继承于JDialog的类传过去
            UserListeners u = new UserListeners(this);
            u.register();
